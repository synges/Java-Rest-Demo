...
@NamedQuery( name = BloodDonation.ALL_BLOOD_DONATIONS_QUERY_NAME, query = "SELECT b FROM BloodDonation b")
@NamedQuery( name = BloodDonation.SINGLE_BLOOD_DONATION_QUERY_NAME, query = "SELECT distinct b FROM BloodDonation b left JOIN FETCH b.record WHERE b.id = :param1")
...
public class BloodDonation extends PojoBase implements Serializable {
	...
	public static final String SINGLE_BLOOD_DONATION_QUERY_NAME = "BloodDonation.findById";
