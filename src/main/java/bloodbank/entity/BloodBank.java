...
@NamedQuery( name = BloodBank.ALL_BLOOD_BANKS_QUERY_NAME, query = "SELECT distinct b FROM BloodBank b left JOIN FETCH b.donations")
@NamedQuery( name = BloodBank.IS_DUPLICATE_QUERY_NAME, query = "SELECT count(b) FROM BloodBank b WHERE b.name=:param1")
@NamedQuery( name = BloodBank.SINGLE_BLOOD_BANK_QUERY_NAME, query = "SELECT distinct b FROM BloodBank b left JOIN FETCH b.donations WHERE b.id = :param1")
...
public abstract class BloodBank extends PojoBase implements Serializable {
	...
	public static final String ALL_BLOOD_BANKS_QUERY_NAME = "BloodBank.findAll";
	public static final String DONATION_COUNT = "BloodBank.donationCOunt";
	public static final String SINGLE_BLOOD_BANK_QUERY_NAME = "BloodBank.findById";
